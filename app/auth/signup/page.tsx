...
export default function SignupPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    router.push("/auth/verify-otp?mobile=" + encodeURIComponent(formData.phone))
  }
    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
      <Card className="w-full max-w-2xl bg-white rounded-lg shadow-lg">
        <CardHeader className="text-center">
          ...
          <p className="text-muted-foreground">Join PharmaFind today! It's quick and easy.</p>
        </CardHeader>
        <CardContent>
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    id="allergies"
                    placeholder="List any allergies (e.g., Penicillin, Aspirin)"
