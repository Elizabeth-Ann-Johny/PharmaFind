...
export default function VerifyOTPPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log("[v0] OTP verification:", otpCode)

    // Get the signup data and create the user account
    const signupData = localStorage.getItem("signupData")
    if (signupData) {
      const userData = JSON.parse(signupData)

      // Process medical conditions and allergies from text to arrays
      ...
      // Save to user and mark as authenticated
      ...
      console.log("[v0] User account created successfully:", finalUserData)
    }
    ...
    <div className="min-h-screen bg-gradient-to-br from-primary/10 via-background to-primary/5 flex items-center justify-center p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl font-bold text-primary">Verify Your Number</CardTitle>
